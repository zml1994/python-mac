...
def CorpQuery(corpCode, corpName):
    ...
    version = '1.0'
    test = 'appid=%s&data=%s&format=%s&method=%s&nonce=%s&timestamp=%s&version=%s' % (appid, data, format, method, nonce, timestamp, version)  # 拼接签名参数
